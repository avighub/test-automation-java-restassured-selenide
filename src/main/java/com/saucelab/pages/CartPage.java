...
public class CartPage {
    ...
    private static final SelenideElement YOUR_CART_TITLE_TEXT = $(byText("Your Cart"));
...
//    private static final SelenideElement CART_ITEM_COUNT = $(byXpath("//span[@class='shopping_cart_badge']"));
    ...
    public CartPage open() {
        ...
        Selenide.open(ENV_CONFIG.cartPageUrl());
        YOUR_CART_TITLE_TEXT.shouldBe(visible);
        return this;
    }

    public CartPage checkHeaderElementsArePresent() {
        MENU_BUTTON.shouldBe(interactable);
        LOGO_TEXT.shouldBe(visible);
        CART_BUTTON.shouldBe(interactable);
        return this;
    }

//    public CartPage checkInventoryPageHeaderElementsArePresent() {
//        PRODUCT_TITLE_TEXT.shouldBe(visible);
//        SORTING_DROPDOWN.shouldBe(visible);
//        return this;
//    }
//
//    public CartPage clickAddToCartButton(String itemName) {
...
//    }
//
//    public CartPage checkIfRemoveButtonIsPresent(String itemName) {
...
//    }
//
//    public CartPage checkItemCountInCart(int count) {
